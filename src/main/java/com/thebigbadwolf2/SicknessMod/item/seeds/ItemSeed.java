package com.thebigbadwolf2.SicknessMod.item.seeds;
...
public class ItemSeed extends ItemWSMod implements IPlantable
{
	...
	public ItemSeed(Block parBlockPlant, Block parSoilBlock)
	{
		super();
		theBlockPlant = parBlockPlant;
		soilId = ModBlocks.encrustedMycelium;
	}
